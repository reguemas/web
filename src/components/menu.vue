        ...
        <b-collapse id="nav-collapse" is-nav class="my-4 justify-content-xl-center justify-content-lg-end justify-content-md-center">
          ...
          <b-navbar-nav class="ml-4"> 
            <b-nav-item-dropdown text="El CET" left>
              <b-dropdown-item @click="goToMenuItem(item)" ref=menuNavegacioCET v-for="(item,index) in menuNavegacio.CET" :key="index">{{item.item}}</b-dropdown-item>
            </b-nav-item-dropdown>
            <b-nav-item-dropdown text="Activitats" left class="ml-5">
              <b-dropdown-header class="dropdown-header-label">
                Activitats Esportives
              </b-dropdown-header>
                <b-dropdown-item @click="goToMenuItem(item)" ref=menuNavegacioCET v-for="(item,index) in menuNavegacio.Esportives" :key="index">{{item.item}}</b-dropdown-item>
              <b-dropdown-divider></b-dropdown-divider>  
              <b-dropdown-header class="dropdown-header-label">
                Activitats Culturals
              </b-dropdown-header>
                <b-dropdown-item @click="goToMenuItem(item)" ref=menuNavegacioCET v-for="(item,index) in menuNavegacio.Culturals" :key="index">{{item.item}}</b-dropdown-item>
              <b-dropdown-divider></b-dropdown-divider>
              <b-dropdown-header id="dropdown-header-label">
                Activitats Socials
              </b-dropdown-header>
                <b-dropdown-item @click="goToMenuItem(item)" ref=menuNavegacioCET v-for="(item,index) in menuNavegacio.Socials" :key="index">{{item.item}}</b-dropdown-item>
              </b-nav-item-dropdown>
            <b-nav-item-dropdown text="Publicacions" left class="ml-5 textCyan">
              <b-dropdown-item @click="goToMenuItem(item)" ref=menuNavegacioCET v-for="(item,index) in menuNavegacio.Publicacions" :key="index">{{item.item}}</b-dropdown-item>
            </b-nav-item-dropdown>
